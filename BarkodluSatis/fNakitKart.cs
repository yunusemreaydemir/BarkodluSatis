...
namespace BarkodluSatis
{
    public partial class fNakitKart : Form
    {
        ...
        {
            if (tNakit.Text != "") //tnakit text boş değilse
            {
                if (e.KeyCode == Keys.Enter) //enter basıldığında 
                {
                    Hesapla();
                }
            }
        ...
        {
            fSatis f = (fSatis)Application.OpenForms["fSatis"]; //açılmış olan forma ulaşmak için 
            ...
            this.Hide();
        } //2 farklı yerde kullanacağım için metot oluşturdum
